package com.scaledrop.sdaccount.configuration.exception.api;

import static com.scaledrop.sdaccount.configuration.exception.api.ApiExceptionType.FORBIDDEN;
import static com.scaledrop.sdaccount.configuration.exception.api.ApiExceptionType.INTERNAL_SERVER_ERROR;
import static com.scaledrop.sdaccount.configuration.exception.api.ApiExceptionType.NOT_FOUND;
import static com.scaledrop.sdaccount.configuration.exception.api.ApiExceptionType.VALIDATION;

import com.google.common.collect.ImmutableMap.Builder;
import com.scaledrop.sdaccount.configuration.exception.SdAccountServiceException;
...
public class ApiExceptionResponseDetailsResolver {
  ...
  private static final Map<Class<? extends Exception>, ApiExceptionResponseDetails> EXCEPTION_RESPONSE_DETAILS_MAP =
      new Builder<Class<? extends Exception>, ApiExceptionResponseDetails>()
          ...
          .put(SdAccountServiceException.class, ApiExceptionResponseDetails.details("Internal server error", INTERNAL_SERVER_ERROR))
          .build();
