...
import static com.scaledrop.sdaccount.configuration.Constants.API_V1_PREFIX;
import static com.scaledrop.sdaccount.configuration.security.role.ApiUserRole.DOCUMENTATION;
import static com.scaledrop.sdaccount.configuration.security.role.ApiUserRole.INTERNAL;
...
import com.scaledrop.sdaccount.configuration.security.properties.SecurityProperties;
import com.scaledrop.sdaccount.configuration.security.properties.SecurityProperties.BasicAuthorization;
  ...
  public static class AuthSecurityConfiguration {
    ...
    private String getCredential(BasicAuthorization basicAuthorization,
      ...
      return Optional.ofNullable(basicAuthorization)
          ...
          .orElseThrow(() -> new SdAccountServiceException(EXTRACTING_API_CREDENTIALS_ERROR_MESSAGE));
    }
  }
