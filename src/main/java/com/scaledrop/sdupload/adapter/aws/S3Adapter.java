...
public class S3Adapter {
    ...
    public String generatePreSignedUploadUrl(UUID fileId, String contentType, String location, String fileName) {
        String s3Key = sanitizeKey(location + fileName);
        String bucketName = amazonS3Properties.getFileserver().getBucket();

        log.info("[S3-ADAPTER] Generating pre-signed URL for Bucket: '{}', Key: '{}'", bucketName, s3Key);
