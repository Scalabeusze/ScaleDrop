...
public interface FileShareResponseMapper {

  default FileShareAPIResponse toResponse(FileShareEntity fileShareEntity) {
    return new FileShareAPIResponse(
        fileShareEntity.getId(),
        fileShareEntity.getFileId(),
        fileShareEntity.getFromId(),
        fileShareEntity.getToId());
  }
}
